    ...
    navigator.getBattery().then((batt) => {
        updateBattery = () => {
            ...
            if (level <= 20) {
                ...
                batteryLiquid.classList.remove("gradient-color-grenn", "gradient-color-orange", "gradient-color-yellow");
            } else if (level <= 48) {
                batteryLiquid.classList.add("gradient-color-orange");
                batteryLiquid.classList.remove("gradient-color-grenn", "gradient-color-red", "gradient-color-yellow");
            } else if (level <= 80) {
                batteryLiquid.classList.add("gradient-color-yellow");
                batteryLiquid.classList.remove("gradient-color-grenn", "gradient-color-orange", "gradient-color-red");
            } else {
